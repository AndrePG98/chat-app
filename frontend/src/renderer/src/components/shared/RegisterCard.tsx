...
export default function RegisterCard() {
	...
	const passwordMeetsReqs =
		isAtLeast8CharsLong && hasUpperCaseChar && hasLowerCaseChar && hasSpecialChar
			...
			<CardBody className="overflow-visible py-2 justify-center">
				...
				<div className="space-y-1.5">
					...
					<Input
						...
						errorMessage={
							registerButtonPressed && !passwordMeetsReqs
				...
				<Button className="max-w-xs mt-5" onClick={() => handleRegister()}>
					Register
				</Button>
			</CardBody>
		</Card>
